...
validate_recipe_outputs "google-cloud-cpp-common-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="google-cloud-cpp-common-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi